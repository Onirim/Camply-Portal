...
const MARKER_ICONS = {
  ...
  question: { d: 'M8.7 8.8a3.4 3.4 0 1 1 4.9 3.9c-.8.7-1.6 1.3-1.6 2.6V15.8 M12 18.4v0.1', stroke: 2.3 },
};
...
const MARKER_SHAPES_I18N = {
  fr: {
    ...
    map_icon_question:  "Point d'interrogation",
  ...
  en: {
    ...
    map_icon_question:  'Question mark',
