...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    config_cleanup_hint:     'Recherche les images (illustrations, cartes) qui ne sont plus utilisées par aucun élément de l\'application et propose de les supprimer pour libérer de l\'espace.',
    config_cleanup_btn:      'Nettoyer les fichiers orphelins',
    config_cleanup_none:     'Aucun fichier orphelin trouvé.',
    config_cleanup_done:     '${count} fichier(s) supprimé(s) (${size} Mo libérés).',
    confirm_cleanup_orphans: '${count} fichier(s) orphelin(s) trouvé(s) (${size} Mo). Les supprimer définitivement ?',
    toast_cleanup_error:     'Erreur lors de la recherche des fichiers orphelins : ',
    toast_cleanup_done:      '${count} fichier(s) orphelin(s) supprimé(s).',
  ...
  en: {
    ...
    config_section_maintenance: 'Maintenance',
    config_cleanup_hint:     'Looks for images (illustrations, maps) that are no longer used by anything in the app and offers to delete them to free up space.',
    config_cleanup_btn:      'Clean up orphaned files',
    config_cleanup_none:     'No orphaned files found.',
    config_cleanup_done:     '${count} file(s) deleted (${size} MB freed).',
    confirm_cleanup_orphans: 'Found ${count} orphaned file(s) (${size} MB). Delete them permanently?',
    toast_cleanup_error:     'Error while looking for orphaned files: ',
    toast_cleanup_done:      '${count} orphaned file(s) deleted.',
